  ...
  categories: [
    {
      ...
      icon: "☕",
      items: [
        { name: "اسپرسو", price: 90 },
        { name: "اسپرسو 50.50", price: 115 },
        {
          name: "قهوه تخصصی (۱۰۰٪ عربیکا)",
          price: 145,
          badge: "پیشنهاد باریستا",
        },
        { name: "اسپرسو رومانو", price: 115 },
        { name: "اسپرسو ماکیاتو", price: 115 },
        { name: "آمریکانو", price: 130 },
        { name: "کورتادو", price: 135 },
        { name: "لته", price: 180 },
        { name: "موکا", price: 190 },
        { name: "کارامل ماکیاتو", price: 190 },
        { name: "کاپوچینو", price: 180 },
      ],
    },
    {
      title: "نوشیدنی گرم",
      icon: "🔥",
      items: [
        { name: "هات چاکلت", price: 170 },
        { name: "شیر عسل", price: 180 },
        { name: "ماسالا", price: 165 },
        { name: "وایت چاکلت", price: 170 },
        { name: "شیرکاکائو", price: 170 },
        { name: "ماچا لته", price: 220 },
        { name: "اسپرولینا", price: 220 },
        { name: "چای کرک", price: 170 },
      ],
    },
    {
      title: "دمنوش",
      ...
      items: [
        ...
        { name: "نگار", desc: "بهار نارنج، به‌لیمو، آویشن", price: 120 },
        { name: "کژال", desc: "گل گاوزبان، به‌لیمو، گل سرخ", price: 120 },
        { name: "چای سبز", price: 105 },
        { name: "چای سیاه", price: 90 },
        { name: "چای ترش", price: 120 },
        { name: "چای کوهی", price: 108 },
      ],
    },
    {
      title: "قهوه دمی",
    ...
    },
    {
      ...
      icon: "🧊",
      items: [
        { name: "آیس لته", price: 165 },
        { name: "آیس لته فندقی", price: 190 },
        { name: "آیس کارامل ماکیاتو", price: 190 },
        { name: "آیس موکا", price: 190 },
        { name: "آیس آمریکانو", price: 145 },
        { name: "آیس چاکلت", price: 180 },
        { name: "آیس ماچا لته", price: 210 },
        { name: "ماچابری", price: 270 },
        { name: "آیس اسپرولینا", price: 210 },
        { name: "خلیج", desc: "اسپرولینا، انبه، یخ‌شیر", price: 290 },
      ],
    },
    {
      title: "شیک",
      icon: "🥤",
      items: [
        { name: "موز شکلات", price: 270 },
        { name: "انبه (با تکه‌های میوه)", price: 290, badge: "جدید" },
        { name: "توت فرنگی", price: 260 },
        { name: "لوتوس", price: 260 },
        { name: "کره گردو", price: 260 },
        { name: "گیان", price: 260 },
        { name: "شیک پروتئینی", desc: "شیر، عسل، کره بادام زمینی", price: 355 },
      ],
    },
    {
      title: "ماکتل",
    ...
    },
    {
      ...
      icon: "🍨",
      items: [
        { name: "آفوگاتو", desc: "وانیل، شکلات", price: 220 },
        { name: "استوایی", desc: "موز، آناناس، انبه، پسته", price: 350 },
      ],
    },
    {
      title: "بستنی",
    ...
    },
    {
      ...
      icon: "🥐",
      items: [
        { name: "کروسان پسته", price: 295 },
        { name: "کروسان شکلات", price: 280 },
        { name: "کروسان لوتوس", price: 285 },
        { name: "رول نیویورکی پسته", price: 290 },
        { name: "رول نیویورکی شکلات", price: 280 },
        { name: "رول نیویورکی لوتوس", price: 295 },
    ...
    },
    {
      ...
      items: [
        { name: "کیک خیس شکلاتی", price: 150 },
        { name: "تیرامیسو", price: 170, badge: "پرفروش" },
        { name: "کیک سه شیر", price: 170 },
        { name: "چیزکیک روز", price: 195 },
        { name: "دبی چاکلت", price: 210 },
        { name: "چیزکیک پسته", price: 340 },
      ],
    },
    {
